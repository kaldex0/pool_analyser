...
class MainWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Analyse Piscine")
    ...
    def generer_pdf(self, data):
        ...
        pdf_file = f"./{month_name}/analyse_bassin_{date_du_jour}.pdf"
        ...
        c.drawString(50, 780, "Rapport d'Analyse Piscine")
        ...
        c.setFillColorRGB(0, 0, 0)
        c.drawString(50, 730, f"Résultat d'analyse : {statut}")
